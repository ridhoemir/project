     ...
     ?>
        ...
        <div class="panel panel-default">
		  ...
		  // membuat kode urut otomatis sebagai ID booking
						$sql = "SELECT max(nomor_penyewaan) as terakhir from detail_penyewaan";
						...
						?>
                        <?php 
						$id_lap = $_REQUEST['IdLapangan'];
						$sel = mysqli_query($koneksi, "select lapangan.*, lapangan.Nama_Lapangan,lapangan.Nomor_Lapangan from lapangan where IdLapangan = '$IdLapangan'");
                        ...
                        <form class="form-horizontal form-label-left" method="post">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Nama Lapangan<span class="required"></span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="last-name" name="last-name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $pilih['Nama_Lapangan'];?>, <?php echo $pilih['alamat_futsal']; ?>" readonly>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="last-name" name="last-name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $pilih['Nomor_Lapangan']; ?>" readonly>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="last-name" name="last-name" required="required" class="form-control col-md-7 col-xs-12" value="Rp. <?php echo $pilih['kode_tarif']; ?>,00" readonly>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class='input-group date' id='datepicker'>
                                <input type='text' class="form-control" name="tgl_main" required/>
                      ...
                      <?php 
						...
						$IdLapangan = $_POST['IdLapangan'];						//variabel yang berisi inputan yang diisi oleh member pada form transaksi
						$tgl_main = $_POST['tgl_main'];
						$jam_mulai = $_POST['jam_mulai'];
						$durasi = $_POST['durasi'];
						//penambahan pada jam mulai dan durasi
						$jamdur = $durasi + $jam_mulai;
						$jam_selesai = $jamdur.":00:00";
						//echo $jam_berakhir;
						...
						}elseif($tgl_main == $tanggal && $jam_mulai < $jam){ // cek tanggal main = tanggal sekarang dan jam mulai kurang dari jam sekarang
							echo "<script> alert(\"Jam mulai kadaluarsa\");</script>";
						}elseif($tgl_main < $tanggal){ // cek tanggal main kurang dari tanggal sekarang
